loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/retraCc/main-sleepy-joe/main/tags.lua'))()

local JFR = loadstring(game:HttpGet('https://raw.githubusercontent.com/retraCc/lib.lua/main/lib.lua'))()
...
--Extra gui stuff
JFR.NewText("Title", bg, {Position = UDim2.new(0, 15, 0, 15), Size = UDim2.new(0, 400, 0, 25), Text = "Dev Build GUI <font size='15'>v"..scriptversion.."</font>", TextSize = 35, TextYAlignment = Enum.TextYAlignment.Center})
...
y=y+30;
JFR.NewText("HomeText2", page_home, {Position = UDim2.new(0, 10, 0, 30), Size = UDim2.new(0, 400, 0, 75), Text = " Dev Build GUI made by retraC<br/>Check out what the new features are in the <b>info</b> tab<br/><br/>Join the discord: <br/><br/><br/><br/>Version "..scriptversion, TextSize = 20})
...
JFR.NewText("InfoText2", page_info, {Position = UDim2.new(0, 10, 0, 30), Size = UDim2.new(0, 400, 0, 700), Text = " "..
    ...
    "<font size='24'><i>Version 2.1.0</i></font><br/> - Messed with how the speed settings work for<br/>CFrame and glide modes (0-210, like the others)<br/> - New indicator where glide will send you<br/> - New height settings<br/> - Some text wasnt centered<br/> - Fixed a slightly transparent frame showing when<br/>it shouldn&apos;t be<br/> - Added settings menu<br/> - Made mod menu more condensed<br/>"..
    "<font size='24'><i>Version 2.0.0</i></font><br/> - Basically stole new GUI<br/> - Added better glide<br/> - Sliders for speed settings<br/> - New overdrive which basically multiplies the<br/>speed setting", TextSize = 18})
